...
<html lang="en">
  ...
  <![endif]-->
    ...
    <body class="bg-light-gray mt-5 " id="body">
                ...
                <div class="col-xl-5 col-lg-6 col-md-10">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <div class="app-brand">
                                <a href="/index.html">
                                    <svg class="brand-icon" xmlns="" preserveAspectRatio="xMidYMid" width="30"
                                    ...
                                    <span class="brand-name">Admin Sign In</span>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="d-flex my-2 justify-content-between">
                                            ...
                                            <p>
                                                <a class="text-blue" href="{{route('password.request')  }}">Forgot Your
                                                    Password?</a> </p>
                                        </div> <button type=" submit" class="btn btn-lg btn-primary btn-block mb-4">Sign
                                            In</button>
